					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Integration Platform Selection Tool",
									"targetURL": "#tipstool-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"tipstool-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tipstool",
									"url": sap.ui.require.toUrl("tipstool")
								}
							}
						}
					}
